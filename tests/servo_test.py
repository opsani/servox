            ...
            "definitions": {
                ...
                "AppdynamicsOptimizer": {
                    ...
                    "properties": {
                        ...
                        "connection_file": {
                            "env": "APPD_CONNECTION_FILE",
                            "env_names": ["APPD_CONNECTION_FILE"],
    ...
    async def test_aliased_connectors_get_distinct_env_configuration(
        ...
        with environment_overrides({"SERVO_DESCRIPTION": "this description"}):
            ...
            s = DynamicServoConfiguration(
                ...
                vegeta=vegeta_settings_type(rate=10, target="http://example.com/"),
            )
...
def test_backoff_contexts() -> None:
    contexts = servox.configuration.BackoffConfigurations(
        __root__={
